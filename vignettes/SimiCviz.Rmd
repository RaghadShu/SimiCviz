...
SimiCviz easily easily handles `SimiCPipeline` outputs but also accepts GRN weights in a flexible long format. The input `data.frame` must include the following columns: 
...
You can extract a TF regulon with the function `get_tf_network` and plot in in heatmap fashion.
```{r}
